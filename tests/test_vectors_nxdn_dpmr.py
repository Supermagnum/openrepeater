...
test_vector_nxdn_voice_valid_1 = {
    ...
    "frame_bits": {
        ...
        "voice_data_scrambled": ("10110010" * 28 + "1011"),  # Simplified - real AMBE data  # Padding
...
test_vector_nxdn_voice_valid_2 = {
    ...
    "validation": {"sync_detection": True, "ran_match": 0, "crc_valid": True, "vocoder_type": "AMBE+2_EHR"},
}
...
def get_test_vectors(protocol=None, validity=None):
    ...
    if validity is None:
        return ALL_TEST_VECTORS[protocol]["valid"] + ALL_TEST_VECTORS[protocol]["invalid"]
    elif validity == "valid":
