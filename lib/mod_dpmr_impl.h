...
#ifndef INCLUDED_QRADIOLINK_MOD_DPMR_IMPL_H
#define INCLUDED_QRADIOLINK_MOD_DPMR_IMPL_H
...
class mod_dpmr_impl : public mod_dpmr
{
private:
...
public:
    mod_dpmr_impl(int sps, int samp_rate, int carrier_freq, int filter_width);
    ~mod_dpmr_impl();
...
#endif /* INCLUDED_QRADIOLINK_MOD_DPMR_IMPL_H */
