...
#ifndef INCLUDED_QRADIOLINK_MOD_2FSK_IMPL_H
#define INCLUDED_QRADIOLINK_MOD_2FSK_IMPL_H
...
class mod_2fsk_impl : public mod_2fsk
{
private:
...
#endif /* INCLUDED_QRADIOLINK_MOD_2FSK_IMPL_H */
