...
#ifndef INCLUDED_QRADIOLINK_DEMOD_QPSK_H
#define INCLUDED_QRADIOLINK_DEMOD_QPSK_H
...
/*!
 * \brief QPSK Demodulator with CCSDS decoding
 * \ingroup qradiolink
 *
 * This block implements a Quadrature Phase Shift Keying (QPSK) demodulator
 * with CCSDS convolutional decoding and descrambling.
 */
class QRADIOLINK_API demod_qpsk : public hier_block2
{
public:
    typedef std::shared_ptr<demod_qpsk> sptr;

    /*!
     * \brief Make a QPSK demodulator block
     *
     * Outputs:
...
protected:
    demod_qpsk(const std::string& name,
...
#endif /* INCLUDED_QRADIOLINK_DEMOD_QPSK_H */
