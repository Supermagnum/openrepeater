...
#ifndef INCLUDED_QRADIOLINK_MOD_4FSK_H
#define INCLUDED_QRADIOLINK_MOD_4FSK_H
...
/*!
 * \brief 4FSK Modulator with CCSDS encoding
 * \ingroup qradiolink
 *
 * This block implements a 4-level Frequency Shift Keying (4FSK) modulator
 * with CCSDS convolutional encoding and scrambling. Designed for amateur
 * radio and digital communications.
 */
class QRADIOLINK_API mod_4fsk : public hier_block2
{
public:
    typedef std::shared_ptr<mod_4fsk> sptr;

    /*!
     * \brief Make a 4FSK modulator block
     *
...
protected:
    mod_4fsk(const std::string& name,
...
#endif /* INCLUDED_QRADIOLINK_MOD_4FSK_H */
