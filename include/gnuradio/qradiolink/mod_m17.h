...
#ifndef INCLUDED_QRADIOLINK_MOD_M17_H
#define INCLUDED_QRADIOLINK_MOD_M17_H
 ...
 * \ingroup qradiolink
 *
 * This block implements an M17 (4FSK) modulator for digital voice.
 */
class QRADIOLINK_API mod_m17 : public hier_block2
{
public:
    typedef std::shared_ptr<mod_m17> sptr;

    /*!
     * \brief Make an M17 modulator block
     *
...
#endif /* INCLUDED_QRADIOLINK_MOD_M17_H */
