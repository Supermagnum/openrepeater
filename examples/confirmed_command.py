...
import confirmed_command_epy_block_0 as epy_block_0  # embedded python block
import threading



class confirmed_command(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "confirmed_command")
...
def main(top_block_cls=confirmed_command, options=None):
