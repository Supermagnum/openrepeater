###############################################################################
#
# ORPVoiceMail module implementation
#
###############################################################################
...
# [ModuleORPVoiceMail] section in the configuration file. The name may be
# changed but it must be changed in both places.
#
namespace eval ORPVoiceMail {
...
#
set cfg_etc "/etc/svxlink/ORPVoiceMail.conf";
set cfg_home ""
if {[info exists ::env(HOME)]} {
  set cfg_home "$env(HOME)/.svxlink/ORPVoiceMail.conf";
}
