...
#ifndef INCLUDED_QRADIOLINK_DEMOD_BPSK_H
#define INCLUDED_QRADIOLINK_DEMOD_BPSK_H
...
/*!
 * \brief BPSK Demodulator with CCSDS decoding
 * \ingroup qradiolink
 *
 * This block implements a Binary Phase Shift Keying (BPSK) demodulator
 * with CCSDS convolutional decoding and descrambling.
 */
class QRADIOLINK_API demod_bpsk : public hier_block2
{
public:
    typedef std::shared_ptr<demod_bpsk> sptr;

    /*!
     * \brief Make a BPSK demodulator block
     *
     * Outputs:
...
protected:
    demod_bpsk(const std::string& name,
...
#endif /* INCLUDED_QRADIOLINK_DEMOD_BPSK_H */
