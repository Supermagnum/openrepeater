...
#ifndef INCLUDED_QRADIOLINK_DEMOD_WBFM_H
#define INCLUDED_QRADIOLINK_DEMOD_WBFM_H
...
/*!
 * \brief WBFM Demodulator
 * \ingroup qradiolink
 *
 * This block implements a Wide Band Frequency Modulation (WBFM) demodulator.
 */
class QRADIOLINK_API demod_wbfm : public hier_block2
{
public:
    typedef std::shared_ptr<demod_wbfm> sptr;

    /*!
     * \brief Make a WBFM demodulator block
     *
     * Outputs:
...
protected:
    demod_wbfm(const std::string& name,
...
#endif /* INCLUDED_QRADIOLINK_DEMOD_WBFM_H */
