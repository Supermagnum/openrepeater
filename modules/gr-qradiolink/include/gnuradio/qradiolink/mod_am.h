...
#ifndef INCLUDED_QRADIOLINK_MOD_AM_H
#define INCLUDED_QRADIOLINK_MOD_AM_H
...
/*!
 * \brief AM (Amplitude Modulation) Modulator
 * \ingroup qradiolink
 *
 * This block implements an AM modulator with AGC and filtering.
 * Note: GNU Radio core only provides AM demodulator, this is a unique modulator.
 */
class QRADIOLINK_API mod_am : public hier_block2
{
public:
    typedef std::shared_ptr<mod_am> sptr;

    /*!
     * \brief Make an AM modulator block
     *
...
#endif /* INCLUDED_QRADIOLINK_MOD_AM_H */
