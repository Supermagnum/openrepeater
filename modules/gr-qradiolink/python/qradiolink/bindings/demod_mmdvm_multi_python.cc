...
void bind_demod_mmdvm_multi(py::module& m)
{
    using demod_mmdvm_multi = gr::qradiolink::demod_mmdvm_multi;

    py::class_<demod_mmdvm_multi,
               gr::hier_block2,
               gr::basic_block,
               std::shared_ptr<demod_mmdvm_multi>>(m, "demod_mmdvm_multi")
        ...
        "Make an MMDVM multi-channel demodulator block. "
        ...
        .def("set_filter_width",
             &demod_mmdvm_multi::set_filter_width,
             py::arg("filter_width"),
             "Set filter width")

        .def("calibrate_rssi",
             &demod_mmdvm_multi::calibrate_rssi,
             py::arg("level"),
             "Calibrate RSSI");
}
