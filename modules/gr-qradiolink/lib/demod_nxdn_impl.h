...
#ifndef INCLUDED_QRADIOLINK_DEMOD_NXDN_IMPL_H
#define INCLUDED_QRADIOLINK_DEMOD_NXDN_IMPL_H
...
class demod_nxdn_impl : public demod_nxdn
{
private:
...
public:
    demod_nxdn_impl(int symbol_rate, int sps, int samp_rate);
    ~demod_nxdn_impl();
};
...
#endif /* INCLUDED_QRADIOLINK_DEMOD_NXDN_IMPL_H */
