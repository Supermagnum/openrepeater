...
#ifndef INCLUDED_QRADIOLINK_MOD_M17_IMPL_H
#define INCLUDED_QRADIOLINK_MOD_M17_IMPL_H
...
class mod_m17_impl : public mod_m17
{
private:
...
public:
    mod_m17_impl(int sps, int samp_rate, int carrier_freq, int filter_width);
    ~mod_m17_impl();
...
#endif /* INCLUDED_QRADIOLINK_MOD_M17_IMPL_H */
