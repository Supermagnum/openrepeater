...
int fx25_decode_frame(fx25_context_t* ctx, const fx25_frame_t* fx25_frame, uint8_t* ax25_data,
...
// Statistics
void fx25_get_stats(const fx25_context_t* ctx, uint32_t* encoded, uint32_t* decoded,
                    uint32_t* errors);
